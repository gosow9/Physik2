	\begin{tabular}{ | c   p{18cm} |}
		...
		\begin{tabular}{L{5cm} L{6.5cm} L{5.3cm}}
			...
			\multicolumn{3}{l}{Bsp: $Q=\int_{kugel}^{}\epsilon_0E(r) dA=\epsilon_0 E(r)4\pi r^2$ mit $E(r)= \frac{Q}{4\pi\epsilon_0 r^2}$  und  $U= \int_{r_1}^{r_2} E(r)dr =\int_{r_1}^{r_2} \frac{Q}{4\pi\epsilon_0 r^2}dr = \frac{Q}{4\pi\epsilon_0}\frac{r_2 r_1}{r_2-r_1} $} \\
