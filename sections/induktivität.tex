	\begin{tabular}{ | c   p{18cm} |}
		...
		\rowcolor[rgb]{0.91,0.91,0.91}
		\textbf{Differentialgleichung}\qquad\qquad\qquad Dynamik an Induktivitäten&$\displaystyle \frac{d i_{L}}{d t}=\frac{u_{L}}{L} \quad$ bzw. $\displaystyle \quad \frac{d i_{1}}{d t}=\frac{u_{2}}{M}$&(Zeitkonstante: $\displaystyle  \tau = L/R$\\[5pt]
